    ...
    const handleConfirmBooking = async () => {
        ...
        try {
            ...
            if (result.ok) {
                ...
                alert("⚠️ Booking confirmed, but email failed to send.");
            }
        } catch (error) {
    ...
    return (
        <div
            ...
            <div className="absolute inset-0 opacity-5">
                <div
                    className="absolute top-0 left-0 w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 bg-gradient-to-br from-blue-400 to-purple-600 rounded-full blur-3xl"></div>
                <div
                    className="absolute bottom-0 right-0 w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 bg-gradient-to-br from-pink-400 to-orange-600 rounded-full blur-3xl"></div>
                <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 bg-gradient-to-br from-green-400 to-blue-600 rounded-full blur-3xl"></div>
            </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                                ...
                                <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
                                    <CardHeader className="p-4 sm:p-6">
                                        <CardTitle className="text-xl sm:text-2xl">Your Selection</CardTitle>
                                    </CardHeader>
                                    <CardContent className="p-4 sm:p-6 pt-0 space-y-4 sm:space-y-6">
                                        ...
                                        {/* Customer Details */}
                                        <div className="space-y-3 sm:space-y-4">
                                            <h3 className="font-semibold text-base sm:text-lg">Customer Details</h3>
                                        ...
                                        {/* Selected Date & Time */}
                                        <div className="space-y-3 sm:space-y-4">
                                            <h3 className="font-semibold text-base sm:text-lg">Appointment Details</h3>
                                        ...
                                        <CardContent className="p-4 sm:p-6 pt-0 space-y-3 sm:space-y-4">
                                            ...
                                            <div className="space-y-2 sm:space-y-3">
                                                <Button
                                                    ...
                                                    className="w-full bg-blue-600 hover:bg-blue-700 text-white shadow-lg text-base sm:text-lg py-4 sm:py-6"
                                                >
                                    ...
                                    <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-green-200">
                                        <CardContent className="p-4 sm:p-6">
                                            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                                                ...
                                                <h4 className="font-semibold text-sm sm:text-base">Payment
                                                    Information</h4>
                                            </div>
