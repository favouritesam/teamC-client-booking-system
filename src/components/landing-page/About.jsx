...
// const About = () => {
//   return (
//     <section id="about" className="py-16 sm:py-24 bg-white flex justify-center items-center">
//       <div className="container flex flex-col md:flex-row items-center justify-between  ">
//         <div className="text-center md:text-left md:w-1/2 ">
//           <h2 className="text-grey-900 font-bold text-3xl mb-3">
//             Crafting Excellence Since 2019
//           </h2>
//           <p className="text-lg text-gray-600 mb-8 leading-relaxed">
//             At Trimless Time Babershop, we believe that grooming is an art form.
//             Our skilled barners combine traditional techniques with modern
//             innovation to deliver exceptional results that exceed your
//             expectations
//           </p>
//           <p className="text-lg text-gray-600 mb-8 leading-relaxed">
//             Located in the heart of downtown, we've built our reputation on
//             quality, consistency and unparalleled customer service. Every visit
//             is an experience designed to leave you looking and feeling your
//             absolute best.
//           </p>
//           <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
//             <div>
//               <img
//                 src="/scissors.svg"
//                 className="inline-flex items-center justify-center w-8 h-9 bg-blue-100 px-2  rounded-lg mb-3"
//               ></img>
...
//               <img
//                 src="/medal.png"
//                 className="inline-flex items-center justify-center w-8 h-9 bg-blue-100 px-2 py-2  rounded-lg mb-3"
//               ></img>
//               <h4 className="font-semibold text-gray-900 mb-1">
//                 Premium Quality
//               </h4>
...
//           <img
//             src="/barbershop.jpg"
//             className="hidden md:block w-3/4 h-auto max-w-md"
//           ></img>
//         </div>
//       </div>
//     </section>
